                                   ...
                                   <div class="row">
                                          ...
                                          <div class="col-sm-5">
                                                 ...
                                                 <div class="field-input">
                                                        ...
                                                        <input type="text" name="precoCompra" class="precoCompra" id="precoCompra" placeholder="R$ 0,00" required value="<?=$produto->precoCompra?>">
                                   ...
                                   <div class="row">
                                          ...
                                          <div class="col-sm-6">
                                                 ...
                                                 <div class="field-input">
                                                        ...
                                                        <input type="text" name="tags" class="tags" id="tags" placeholder="Exemplo: bermudas, camisas, blusas" value="<?=$produto->tags;?>">
